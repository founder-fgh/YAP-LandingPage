  ...
  return (
    <div className="flex flex-col justify-center items-center">
      <div className="flex items-center px-10 mx-3 my-10">
        <h1 className="text-white bg-green-700 rounded-xl p-3 text-3xl font-bold">
          Testimonials
        </h1>
        <p className="mx-5 py-5 w-6/12 text-xl text-left">
      ...
      <div className="slider-container flex flex-col bg-black p-9 rounded-4xl text-white w-11/12 md:max-h-[85vh]">
        ...
        >
          {testimonials.map(testmonial => (
            <div>
              <p className="testimonial-box p-9 h-48 border-2 border-green-500 text-xl rounded-3xl">
                {testmonial.review}
              </p>
              <h3 className="text-green-300 font-semibold text-xl mx-8 ">
                {testmonial.name}
              </h3>
