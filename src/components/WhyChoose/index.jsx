...
const WhyChoose = () => (
    ...
    <div className="flex items-center my-5 py-5 w-10/12">
        <h1 className="text-white bg-green-700 rounded-xl p-3 text-3xl font-bold w-5/12 mr-7">Why Choose YAP</h1>
        <p className="text-left text-lg w-10/12">YAP delivers in just 30 minutes with trusted local vendors,
            ensuring freshness and community support. Unlike others,
            we blend speed, reliability, and local care for a better shopping 
            experience
        </p>
    </div>
